...
export default function Landing() {
  ...
  // Create an opacity value that fades from fully opaque to transparent between 100 and 475 scroll positions
  const fadeOpacity = useTransform(scrollY, [100, 475], [1, 0]);
  const fadeY = useTransform(scrollY, [100, 475], [0, -100]);
